...
namespace libs_qrem {
    ...
    int QREM_Filter_Nlp::index_of_matrix(string state, vector<int>& pos_clbits) {
        int index = 0;
        int i = 0;
    ...
    double QREM_Filter_Nlp::mitigate_one_state(int target_index, 
    ...
    vector<double> QREM_Filter_Nlp::col_basis(int col_index, 
    ...
    vector<Vector2d> QREM_Filter_Nlp::choose_vecs(string state, vector<Matrix2d> matrices) {
    ...
    double QREM_Filter_Nlp::sum_of_tensored_vector(vector<Vector2d> vecs) {
        double sum_val = 1;
    ...
    vector<double> QREM_Filter_Nlp::apply(map<string, int> hist,
                                           int d = 0,
